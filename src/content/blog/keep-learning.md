...
As I mentioned in [a previous blog post](/blog/dont-replace-yourself-with-ai), I said that I've been doing some experimentation with AI just to have an idea of what's going on. I've given it tasks both simple and complex, and one thing I can tell you from my experience is that whatever command or directions it offers, it doesn't stick in my brain. When I'm using AI in this way, I am getting something done, but I'm not learning, not growing as an IT professional or software engineer. [This is not an unknown experience](https://news.harvard.edu/gazette/story/2025/11/is-ai-dulling-our-minds/), and is in fact what I was talking about in that last post I wrote. When we turn over the wheel to AI, we don't just stop thinking, we stop learning.
...
As an example, we don't say that you should only use paper and pen to write, and that computers are the bane of written existence. But we do say that typically, [handwritten notes or journals have a better chance of sticking in your brain than something you type](https://www.scientificamerican.com/article/why-writing-by-hand-is-better-for-memory-and-learning/). That's a tradeoff: do I want to write fast, or do I want to remember what I wrote?
