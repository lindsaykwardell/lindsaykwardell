...
tags: []
type: Podcast
snippet: "Lindsay and Steve talk with Subha Chanda, freelance developer, about a number of topics related to building and managing your own sites. They discuss Subha’s work as a writer, and his work writing for LogRocket (and others), focusing on his article on using ImageKit and Vue. They also discuss the current state of using Nuxt, integrating with a CMS, and what tools Subha reaches for when doing freelance work."
link: "https://topenddevs.com/podcasts/views-on-vue/episodes/tools-that-inspire-us-with-subha-chanda-vue-180"
name: "Views on Vue"
host: true
---
